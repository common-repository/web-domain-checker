 ...
 */
class ocwdc_domain_availability {
	 ...
	 * @return boolean true means the domain is NOT registered
	 */
	public function is_available($domain, $domain_tld) {
		...
		if (isset($whois_arr[$tld][0])) {
			...
			$status = $this->checkDomainNameAvailabilty($domain_name, $whois_server, $bad_string);
			return $status;
		} else {
			// TODO: REFACTOR THIS
